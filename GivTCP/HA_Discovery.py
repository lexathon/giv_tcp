...
class HAMQTT():
    ...
    entity_type={
        ...
        "Inverter_Energy_Total_kWh":["sensor","energy"],
        ...
        "Inverter_Energy_Today_kWh":["sensor","energy"],
        ...
        "Inverter_Serial_Number":["sensor","",""],
        "Modbus_Version":["sensor",""],
        "Meter_Type":["sensor",""],
        "Inverter_Type":["sensor",""],
        "Inverter_Temperature":["sensor","temperature"],
